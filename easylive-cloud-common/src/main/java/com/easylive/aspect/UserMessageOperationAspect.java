...
import com.easylive.api.consumer.MessageClient;
...
public class UserMessageOperationAspect {
    ...
    private void saveUserMessage(RecordUserMessage recordUserMessage, Object[] arguments, Parameter[] parameters) {
        ...
        messageClient.saveUserMessage(videoId, tokenUserInfoDto == null ? null : tokenUserInfoDto.getUserId(), messageTypeEnum.getType(), content, replyCommentId);
    }
}